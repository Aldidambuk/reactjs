    ...
    <div className="row">
      <form className='gradient-custom' onSubmit={simpanData}>
        <div className="form-group row  justify-content-Between">
          <label htmlFor="judul" className="col-sm-4 col-form-label bg-color:red">Judul Film</label>
        ...
        <div className="form-group row">
          <label htmlFor="sutradara" className="col-sm-4 col-form-label">Sutradara</label>
          <div className="col-sm-10">
        ...
        <div className="form-group row">
          <label htmlFor="image" className="col-sm-4 col-form-label">Gambar Cover</label>
          <div className="col-sm-10">
